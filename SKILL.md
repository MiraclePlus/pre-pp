...
#### 1. 第一页黄金规则
- **核心目标：让观众一眼就懂产品是什么**（这是硬要求；至于用什么手段，留给创始人发挥）
- 类比法是最常用的捷径（"XX行业的Cursor"、"AI时代的企业黑客"），但不是唯一解——直接定位、一句话场景、反差金句也都能让人秒懂，选最贴合项目的那种
- **5秒记忆测试**：投资人听完能否立刻转述？
- **避免术语堆砌**：少用"平台"、"系统"、"方案"等虚词
...
#### 3. 吸睛度（整体有记忆点，而非逐页打钩）
目标是整份 deck 足够吸引人、有让人记住的高光时刻——不要求每一页都强行塞钩子，而是确保全局有几个真正"哇"的瞬间。常见的钩子素材：
- 震撼数据："164亿美金"、"覆盖率提升3倍"
...
判断标准：通读全篇，能不能找出 2-3 个让投资人抬头、想追问、愿意转述的点？平铺直叙、从头到尾没有起伏才是真问题；个别过渡页平淡是正常的。
...
**理由**: 让投资人一眼看懂（这里用了类比，也可换成场景/反差，只要秒懂即可）
...
### 整体吸睛度
- 高光点盘点：第1页类比定位、第3页10倍对比、第8页愿景——全篇有 3 个能让人转述的点 ✅
- 平淡区间：第5-6页连续两页纯功能罗列，建议合并或在其中插入一个数据/场景钩子
- （不要求每页打钩，重点是全篇有起伏、有记忆点）
...
# 编辑已有飞书 Slides
/pre-PP Meridian 帮我改这个飞书slides的第3页 https://example.feishu.cn/slides/xxx
